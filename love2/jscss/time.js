function showTime() { 
	...
	var startDate = new Date(2018, 8, 27);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Qin:<br>"
		+ "与你相识:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----wencai   2018-10-12</c>"; 
